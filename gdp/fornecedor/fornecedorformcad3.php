...
if(@$_SESSION['fornecedor']['cod_cli'] == '')
	{
if(@$_SESSION['fornecedor']['pessoa'] == 'pf')
{
	$id = @$_POST['codigo'];
	$_SESSION['fornecedor']['cod_cli'] = $id;
	
}
elseif(@$_SESSION['fornecedor']['pessoa'] == 'pj')
{
	$id = @$_POST['codigo'];
	$_SESSION['fornecedor']['cod_cli'] = $id;
}
...
if($id == '')
{
		...
		echo '<script>window.location="index.php?mod=gdp&bot=tes5&cad=2"</script>';
...
$fornecedor = new classcad3();
$fornecedor->cad3('gdp','tes5','Fornecedor',$fornec);
