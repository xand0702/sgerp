...
@$_SESSION['fornecedor']['cod_cli'] = '';

if(@$_SESSION['fornecedor']['pessoa'] == 'pf')
	@$_SESSION['fornecedor']['pessoa'] = $pessoa;
elseif(@$_SESSION['fornecedor']['pessoa'] == 'pj')
	@$_SESSION['fornecedor']['pessoa'] = $pessoa;
elseif(@$_SESSION['fornecedor']['pessoa'] == '')
	@$_SESSION['fornecedor']['pessoa'] = $pessoa;
	...
	$(function(){
		$("input[name='codigo']").blur(function(){
			...
			$( cpf ).val('Carregando...');
				...
				$.getJSON(
					"gdp/fornecedor/ch_pessoafisica.php",
					{ codigo: $( this ).val() },
					function( json )
					{
						$( nome ).val( json.nome );
...
<form enctype="multipart/form-data" action="index.php?mod=gdp&bot=tes5&cad=3" method="post">
	...
	$(function(){
		$("input[name='codigo']").blur(function(){
			...
			$( cnpj ).val('Carregando...');
				...
				$.getJSON(
					"gdp/fornecedor/ch_pessoajuridica.php",
					{ codigo: $( this ).val() },
					function( json )
					{
						$( nome ).val( json.nome );
