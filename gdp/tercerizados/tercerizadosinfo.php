...
<div class="label4"> Informação do Tercerizado </div>
...
?>		
		...
		<tr>
			...
			<td align=left>
			<?php print databr($row['TER_DATA_VENC']); ?>
			</td>
		</tr>
		<tr>
			<td width=50%>
		...
		<tr>
			...
			<td align=left>
			<?php print databr($row['TER_DATA_INI']); ?>
			</td>
		</tr>
		...
		<tr>
			...
			<td align=left>
			<?php print databr($row['TER_DATA_FIM']); ?>
			</td>
		</tr>
...
<div class="label5">	
	...
	<form action="gdp/tercerizados/relatorios/info.php" method="post" target="_blank">
	...
	<tr>
		...
		<td width=50%> 
			<form action="gdp/tercerizados/tercerizadosinfodireciona.php">
			<div class="modal-footer">
