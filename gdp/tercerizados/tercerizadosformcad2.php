...
@$_SESSION['tercerizados']['cod_cli'] = '';

if(@$_SESSION['tercerizados']['pessoa'] == 'pf')
	@$_SESSION['tercerizados']['pessoa'] = $pessoa;
elseif(@$_SESSION['tercerizados']['pessoa'] == 'pj')
	@$_SESSION['tercerizados']['pessoa'] = $pessoa;
elseif(@$_SESSION['tercerizados']['pessoa'] == '')
	@$_SESSION['tercerizados']['pessoa'] = $pessoa;
	...
	$(function(){
		$("input[name='codigo']").blur(function(){
			...
			$( cpf ).val('Carregando...');
				...
				$.getJSON(
					"gdp/tercerizados/ch_pessoafisica.php",
					{ codigo: $( this ).val() },
					function( json )
					{
						$( nome ).val( json.nome );
...
<form enctype="multipart/form-data" action="index.php?mod=gdp&bot=tes6&cad=3" method="post">
	...
	$(function(){
		$("input[name='codigo']").blur(function(){
			...
			$( cnpj ).val('Carregando...');
				...
				$.getJSON(
					"gdp/tercerizados/ch_pessoajuridica.php",
					{ codigo: $( this ).val() },
					function( json )
					{
						$( nome ).val( json.nome );
