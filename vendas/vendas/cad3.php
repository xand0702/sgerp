...
function cad3( $subdir, $codigo)
{


$fp = fopen("comprar/".$subdir."/tmp/cad3.php", "w+");
...
function cad31($dir, $tes, $subdir, $tit, $dados)
{
	
	//
		//"'.$dir.'/'.$subdir.'/'.$subdir.'cadastro.php"
	
	$fp = fopen("comprar/".$subdir."/tmp/cad3.php", "a+");
...
<form enctype="multipart/form-data" name="form2" action="comprar/'.$subdir.'/'.$subdir.'cadastro.php" method="post">
