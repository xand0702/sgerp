...
require_once('vendas/vendas/cad4.php'); 
...
@$fornec[3][0] = "dt_vendas";
@$fornec[3][1] = "";

@$fornec[4][0] = "hr_vendas";
@$fornec[4][1] = "";
...
$tvendase = new classcad4();
$tvendase->cad4('ven','tes1','vendas' ,'cod_cli' , $fornec);
...
$dados[3][1] = 'dt_vendas';//variavel
$dados[3][2] = 'data';//tipo


$dados[4][0] = 'Hora da saída';//label
$dados[4][1] = 'hr_vendas';//variavel
$dados[4][2] = 'text';//tipo
...
$tvendase = new classcad41();
$tvendase->cad41('ven','tes1','vendas' ,'Pedido' ,$dados);
		
		

require_once('vendas/vendas/tmp/cad4.php'); 		
...
<table border=0 valign=top width=100%>
	...
	<tr>
		<td width=50%><label>Orgão de Exvendas: </label></td>
...
$vendasadocivil = $row['PEF_ESTADO_CIVIL'];
		
$sqlvendasadocivil = 'SELECT *
FROM civil
WHERE CIV_ID = '.$vendasadocivil.'
...
';
	...
	foreach ($conn->query($sqlvendasadocivil) as $rowvendasadocivil) 
	{
		
			$nomecvendasadocivil = $rowvendasadocivil['CIV_NOME'];
	...
	?>	
		...
		<td width=50% class=tabinfo3> <?php echo utf8_encode($nomecvendasadocivil); ?> </td>
	</tr>
	<tr>
