<?php
   ...
   require_once('/../../../bd/connect.php');
    ...
    function Header()
    {
        ...
        $header = array( 'Codigo do Vendedor', 'Nome', 'ID funcionario', 'Valor da Venda');
...
GROUP BY vd.FAT_VENDEDOR_CODIGO
...
$totalven = 0;
    $conta = 0;
        while ($linha = mysql_fetch_assoc($result)) {
            ...
            $pdf->Cell($w[2],0.5,$linha["idfun"],0,0,'L',$fill);
    ...
    $pdf->Cell(0,1,  utf8_decode("Valor total das vendas: ").$totalven,0,0,'L',$fill);    
