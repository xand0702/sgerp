...
require_once('comprar/pedido/cad4.php'); 
...
@$fornec[3][0] = "dt_pedido";
@$fornec[3][1] = "";

@$fornec[4][0] = "hr_pedido";
@$fornec[4][1] = "";
...
$tpedidoe = new classcad4();
$tpedidoe->cad4('com','tes1','pedido' ,'cod_cli' , $fornec);
...
$dados[3][1] = 'dt_pedido';//variavel
$dados[3][2] = 'data';//tipo


$dados[4][0] = 'Hora da saída';//label
$dados[4][1] = 'hr_pedido';//variavel
$dados[4][2] = 'text';//tipo
...
$tpedidoe = new classcad41();
$tpedidoe->cad41('com','tes1','pedido' ,'Pedido' ,$dados);
		
		

require_once('comprar/pedido/tmp/cad4.php'); 		
