	...
	$(function(){
		$("input[name='codigop']").blur(function(){
			...
			$( fab ).val('Carregando...');
				...
				$.getJSON(
					"comprar/pedido/ch_produtopa.php",
					{ codigo: $( this ).val() },
...
<form name="form1" action="comprar/pedido/cad2insere.php" method="post">		
		...
		<tr>
			...
			<h4>Insira os dados do Pedido</h4>
			</td>
		...
		<tr>
			<td align=right>
			<label>Data Entrega(estitiva): </label>
			</td>
	...
	$(function(){
		$("input[name='codigof']").blur(function(){
			...
			$( docm ).val('Carregando...');
				...
				$.getJSON(
					"comprar/pedido/ch_fornecedor.php",
					{ codigof: $( this ).val() },
...
<a href="comprar/pedido/limpa.php">LIMPA</a>
</div>	
		</td>
