...
require_once('comprar/pedido/cad3.php'); 



$tpedidoe = new classcad3();
$tpedidoe->cad3('pedido' ,'cod_cli');



$dados[0][0] = '';//label
$dados[0][1] = 'tcome';//variavel
$dados[0][2] = 'text';//tipo


$tpedidoe = new classcad31();
$tpedidoe->cad31('com','tes1','pedido' ,'Saida' ,$dados);
		
		

require('comprar/pedido/tmp/cad3.php'); 		
