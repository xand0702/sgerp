		...
		<!-- Modal -->
  <div class="modal fade" id="saidaalt<?php echo @$row['id']; ?>" role="dialog">
...
<form action="est/saida/saidaalt.php" method="post">

<input type="hidden" value="<?php echo @$row['id']; ?>" name="id">
<input type="hidden" value="<?php echo @$row['material']; ?>" name="id">
