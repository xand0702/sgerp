...
$tsaidae = new classcad4();
$tsaidae->cad4('est','tes4','saida' ,'cod_cli' , $fornec);
...
$tsaidae = new classcad41();
$tsaidae->cad41('est','tes4','saida' ,'Pedido' ,$dados);
		
		

require_once('estoque/saida/tmp/cad4.php'); 		
