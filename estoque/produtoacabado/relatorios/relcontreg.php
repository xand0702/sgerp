...
if($dt_ini > $dt_fim)
{
	...
	if(($dt_ini && $dt_fim) == '')
	{	$auxsql = "
SELECT e.EPA_DATA_CADASTRO cadastro,
e.EPA_CODIGO codigo, e.EPA_NOTA nota,
e.EPA_DATA_CADASTRO entrada,
e.EPA_HORA_CADASTRO hora, 
e.EPA_COD_PESSOA forcod,

pf.PEF_NOME nomefor

FROM entradapa e, fornecedor fo, pessoa_fisica pf
WHERE e.EPA_COD_PESSOA = fo.FOR_CODIGO
...
FROM entradapa e, fornecedor fo, pessoa_juridica pj
WHERE e.EPA_COD_PESSOA = fo.FOR_CODIGO
...
WHERE e.EPA_COD_PESSOA = fo.FOR_CODIGO
AND fo.FOR_COD_PESSOA = pf.PEF_CODIGO
AND e.EPA_DATA_CADASTRO BETWEEN '".$dt_ini."' AND '".$dt_fim."' 
GROUP BY cadastro
UNION ALL
SELECT e.EPA_DATA_CADASTRO cadastro,
e.EPA_CODIGO codigo, e.EPA_NOTA nota,
...
$codfun = $row["codigo"];
	...
	$auxsqlfun = "	SELECT pf.PEF_NOME nomefun, e.EPA_RECEBIDO codfun
FROM entradapa e, funcinario f, pessoa_fisica pf
WHERE e.EPA_RECEBIDO = f.FUN_CODIGO
AND f.FUN_COD_PEF = pf.PEF_CODIGO
AND e.EPA_CODIGO =  ".$codfun;
