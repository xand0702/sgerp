...
require_once('estoque/cad3.php'); 
	...
	$id = @$_POST['codigo'];
	$_SESSION['produtoacabado']['cod_cli'] = $id;
...
if($id == '')
{
		...
		echo '<script>window.location="index.php?mod=estoque&bot=tes2&cad=2"</script>';
...
$fornec[0][1] 	= 'Number';
$fornec[0][2] 	= 'nota';
$fornec[0][3] 	= 'placeholder="Preenchimento Obrigatório"';





$fornec[1][0] 	= 'Pedido';										//label
$fornec[1][1] 	= 'number';										//type
$fornec[1][2] 	= 'pedido';										//name
$fornec[1][3] 	= 'placeholder="Preenchimento Obrigatório"';	//placeholder="Preenchimento Obrigatório"

$fornec[2][0] 	= 'Data Emissão';
$fornec[2][1] 	= 'date';
$fornec[2][2] 	= 'dt_emissao';
$fornec[2][3] 	= 'placeholder="Preenchimento Obrigatório"';

$fornec[3][0] 	= 'Data Saída';
$fornec[3][1] 	= 'date';
$fornec[3][2] 	= 'dt_saida';
$fornec[3][3] 	= 'placeholder="Preenchimento Obrigatório"';

$fornec[4][0] 	= 'Hora da saída';
$fornec[4][1] 	= 'time';
$fornec[4][2] 	= 'hr_saida';
$fornec[4][3] 	= 'placeholder="Preenchimento Obrigatório"';


$fornec[5][0] 	= 'Controle Fisco (Código de barras)';
$fornec[5][1] 	= 'number';
$fornec[5][2] 	= 'cfcb';
$fornec[5][3] 	= 'placeholder="Preenchimento Obrigatório"';

$fornec[6][0] 	= 'Série';
$fornec[6][1] 	= 'number';
$fornec[6][2] 	= 'serie';
$fornec[6][3] 	= 'placeholder="Preenchimento Obrigatório"';

$fornec[7][0] 	= 'Página';
$fornec[7][1] 	= 'number';
$fornec[7][2] 	= 'pagina';
$fornec[7][3] 	= 'placeholder="Preenchimento Obrigatório"';

$fornec[8][0] 	= 'Natureza da Operação';
$fornec[8][1] 	= 'text';
$fornec[8][2] 	= 'nt_op';
$fornec[8][3] 	= 'placeholder="Preenchimento Obrigatório"';

$fornec[9][0] 	= 'NFE';
$fornec[9][1] 	= 'text';
$fornec[9][2] 	= 'nfe';
$fornec[9][3] 	= 'placeholder="Preenchimento Obrigatório"';





$produtoacabado = new classcad3();
$produtoacabado->cad3('est','tes2','Fornecedor',$fornec);
...
<script type="text/javascript" src="jquery.min.js"></script>	
	...
	$(function(){
		$("input[name='codigoe']").blur(function(){
			...
			$( cpf ).val('Carregando...');
				...
				$.getJSON(
					"estoque/produtoacabado/ch_recebido.php",
					{ codigo: $( this ).val() },
					function( json )
					{
						$( nome ).val( json.nome );
		...
		<tr>
			<td align=right>
			<label>Recebido pelo funcionário(código): </label>
			</td>
			<td align=left>
			<div class="col-xs-8">
			<input type="text" id="codigo" name="codigoe" class="form-control" placeholder="Preenchimento Obrigatório">
			</div>
