...
SELECT e.EPA_CODIGO , e.EPA_NOTA , e.EPA_ID,
e.EPA_PEDIDO ,e.EPA_CONT_FISCO, e.EPA_SERIE, e.EPA_PAGINA,
e.EPA_NAT_OP, e.EPA_CH_NFE, e.EPA_DT_EMISSAO, e.EPA_DT_SAIDA,
e.EPA_HR_SAIDA, 
...
WHERE e.EPA_COD_PESSOA = f.FOR_CODIGO
AND f.FOR_COD_PESSOA = pf.PEF_CODIGO
AND e.EPA_CODIGO = ".$altn."
GROUP BY e.EPA_CODIGO
UNION ALL
SELECT e.EPA_CODIGO , e.EPA_NOTA , e.EPA_ID,
e.EPA_PEDIDO ,e.EPA_CONT_FISCO, e.EPA_SERIE, e.EPA_PAGINA,
e.EPA_NAT_OP, e.EPA_CH_NFE, e.EPA_DT_EMISSAO, e.EPA_DT_SAIDA,
...
<form action="estoque/produtoacabado/produtoacabadoalt.php" method="post">	
	<center>
	<table border="0" cellspacing=5 cellpadding=5>
	...
	<td>
	<input type="text" value="<?php echo $row['EPA_NOTA']; ?>" class="form-control">
	</td>
	</tr>
	...
	<td>
	<input type="text" value="<?php echo $row['EPA_PEDIDO']; ?>" class="form-control">
	</td>
	</tr>
	...
	<td>
	<input type="text" value="<?php echo $row['EPA_CONT_FISCO']; ?>" class="form-control">
	</td>
	</tr>
	...
	<td>
	<input type="text" value="<?php echo $row['EPA_SERIE']; ?>" class="form-control">
	</td>
	</tr>
	...
	<td>
	<input type="text" value="<?php echo $row['EPA_PAGINA']; ?>" class="form-control">
	</td>
	</tr>
	...
	<td>
	<input type="text" value="<?php echo $row['EPA_NAT_OP']; ?>" class="form-control">
	</td>
	</tr>
	...
	<td>
	<input type="text" value="<?php echo $row['EPA_CH_NFE']; ?>" class="form-control">
	</td>
	</tr>
	...
	<td>
	<input type="date" value="<?php echo $row['EPA_DT_EMISSAO']; ?>" class="form-control">
	</td>
	</tr>
	...
	<td>
	<input type="date" value="<?php echo $row['EPA_DT_SAIDA']; ?>" class="form-control">
	</td>
	</tr>
	...
	<td>
	<input type="time" value="<?php echo $row['EPA_HR_SAIDA']; ?>" class="form-control">
	</td>
	</tr>
...
WHERE e.EPA_ID = i.IPA_ENTRADAPA
