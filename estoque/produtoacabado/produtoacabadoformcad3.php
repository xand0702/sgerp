...
$teste = new classcad4();
$teste->cad4('est','tes2','produtoacabado' ,'cod_cli' , $fornec);
...
$teste = new classcad41();
$teste->cad41('est','tes2','produtoacabado' ,'Pedido' ,$dados);
		
		

require_once('estoque/tmp/cad4.php'); 		
